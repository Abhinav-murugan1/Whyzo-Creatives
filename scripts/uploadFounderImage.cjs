...
const sourceImage = 'C:/Users/ABHIN/.gemini/antigravity/brain/a2b83818-6096-4756-adfb-d6302171da8f/.user_uploaded/media_1789736739954.jpg';
...
// Copy locally to assets as backup
const destDir = path.resolve(__dirname, '../src/assets/PHOTOS/TEAM');
if (!fs.existsSync(destDir)) {
  fs.mkdirSync(destDir, { recursive: true });
}
const localCopy = path.join(destDir, 'fayaz_founder.jpg');

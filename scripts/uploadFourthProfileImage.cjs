...
const sourceImage = 'C:/Users/ABHIN/.gemini/antigravity/brain/a2b83818-6096-4756-adfb-d6302171da8f/.user_uploaded/media_1789740742117.jpg';
...
const localCopy = path.join(destDir, 'member_04.jpg');
fs.copyFileSync(sourceImage, localCopy);
console.log('Saved local copy to:', localCopy);

async function upload() {
  try {
    console.log('Uploading fourth profile image to Cloudinary...');
